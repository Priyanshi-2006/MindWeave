    ...
    <div className="grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto my-6">
      <section className="animate-pop space-y-4">
        ...
        <div className="mt-6 space-y-3">
          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-card border-2 border-border shadow-soft text-card-foreground">
            <span className="text-2xl">🧭</span>
            <div>
              <p className="font-display font-bold text-base text-foreground">Path Navigation</p>
          ...
          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-card border-2 border-border shadow-soft text-card-foreground">
            <span className="text-2xl">👀</span>
            <div>
              <p className="font-display font-bold text-base text-foreground">Spot the Difference</p>
          ...
          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-card border-2 border-border shadow-soft text-card-foreground">
            <span className="text-2xl">🎵</span>
            <div>
              <p className="font-display font-bold text-base text-foreground">Memory Sequence</p>
          ...
          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-card border-2 border-border shadow-soft text-card-foreground">
            <span className="text-2xl">🔎</span>
            <div>
              <p className="font-display font-bold text-base text-foreground">Story & Logic</p>
      ...
      >
        <h2 className="font-display text-2xl font-bold text-foreground">Set Up Patient Profile</h2>
        ...
        <label className="block text-sm font-bold text-foreground">
          ...
          <input
            ...
            required
            className="mt-1.5 w-full rounded-2xl border-2 border-border bg-card text-foreground px-4 py-3.5 text-base font-semibold outline-none focus:border-primary placeholder:text-muted-foreground/60"
          />
        </label>
        ...
        <div>
          <label className="block text-sm font-bold text-foreground mb-2">Select Assistance & Guidance Mode</label>
          <div className="grid grid-cols-3 gap-2 text-center">
            {(["independent", "guided", "high-support"] as CareLevel[]).map((level) => (
              <button
                ...
                className={`p-3 rounded-xl border-2 font-display text-sm font-bold transition-all cursor-pointer ${
                  careLevel === level
                    ? "border-primary bg-primary/20 text-primary font-bold shadow-soft"
        ...
        <button
          type="submit"
          className="toy-press w-full rounded-full bg-primary px-6 py-4 font-display text-xl font-bold text-primary-foreground shadow-soft cursor-pointer"
        >
