        ...
        <section className="panel space-y-6 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-2xl bg-muted/40 p-4 border border-border/50">
              <div>
                <p className="font-display text-base font-bold">Dark High Contrast Mode</p>
                <p className="text-xs text-muted-foreground">High-visibility dark mode with bold borders and bright crisp text.</p>
              </div>
              <button
                onClick={() =>
              ...
              >
                {profile.accessibility?.highContrast ? "ON (Active)" : "OFF"}
              </button>
            </div>
